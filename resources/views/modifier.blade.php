...
<main class="container">
  ...
  <div class="my-3 p-3 bg-body rounded shadow-sm">
    <h4 class="border-bottom pb-2 mb-4">Modifier un Chauffeur</h4>
    <hr>
    @if (session('status'))
    ...
    <form action="modifier/traitement" method="POST">
        ...
        <div class="mb-3">
           <label for="Num_permis" class="form-label">Num_permis</label>
           <input type="text" class="form-control" id="Num_permis" name="Num_permis"value="{{ $chauffeurs->Num_permis }}">
        </div>

        <div class="mb-3">
           <label for="Emission" class="form-label">Emission</label>
           <input type="date" class="form-control" id="Emission" name="Emission" value="{{ $chauffeurs->Emission }}">
        </div>

        <div class="mb-3">
           <label for="Expiration" class="form-label">Expiration</label>
           <input type="date" class="form-control" id="Expiration" name="Expiration" value="{{ $chauffeurs->Expiration }}">
        </div>

        <div class="mb-3">
           <label for="Categorie" class="form-label">Categorie</label>
           <input type="text" class="form-control" id="Categorie" name="Categorie" value="{{ $chauffeurs->Categorie }}">
        </div>
        
         <button type="submit" class="btn btn-primary">Modifier un chauffeur</button><br><br>
         <a href="/liste" class="btn btn-danger">Liste des chauffeurs</a>
    </form>
    </div>
