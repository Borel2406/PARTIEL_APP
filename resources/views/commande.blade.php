...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark" aria-label="Main navigation">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Dashboard Clients</a>
...
<main class="container">
  <div class="d-flex align-items-center p-3 my-3 text-white bg-purple rounded shadow-sm">
    ...
    <div class="lh-1">
      <h1 class="h6 mb-0 text-white lh-1">Passez votre commande de voiture</h1><br>
      <small>Depuis votre destination</small>
    </div>
  </div>
...
<div>
  <a href="" class="btn btn-success">se déconnecter</a>
</div><br>
   </div>
