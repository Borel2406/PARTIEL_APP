...
<main class="container">
  ...
  <div class="my-3 p-3 bg-body rounded shadow-sm">
    <h4 class="border-bottom pb-2 mb-4">Ajouter un Chauffeur</h4>
    <hr>
    @if (session('status'))
    ...
    <form action="ajouter/traitement" method="POST">
        ...
        <div class="mb-3">
           ...
           <input type="date" class="form-control" id="Emission" name="Emission">
        </div>
        ...
        <div class="mb-3">
         ...
         <button type="submit" class="btn btn-primary">Ajouter un chauffeur</button><br><br>
