...
<main class="container">
  ...
  <div class="my-3 p-3 bg-body rounded shadow-sm">
    <h4 class="border-bottom pb-2 mb-4">Ajouter une voiture</h4>
    <hr>
    @if (session('status'))
    ...
    <div class="mt-4">
    <form action="ajoutervoiture/traitement" method="POST">
        @csrf
        ...
        <div class="mb-3">
           ...
           <input type="text" class="form-control" id="ParcoursDefaut" name="ParcoursDefaut">
        </div>
        ...
        <div class="mb-3">
         ...
         <button type="submit" class="btn btn-primary">Ajouter une voiture</button><br><br>
