...
<main class="container">
  ...
  <div class="my-3 p-3 bg-body rounded shadow-sm">
    <h4 class="border-bottom pb-2 mb-4">Liste des chauffeurs  Validés</h4>
    <div class="mt-4">
        <div class="d-flex justify-content-end  mb-3">
        <a href="ajouter" class="btn btn-primary">Ajouter un chauffeur</a>
        </div><hr>
          @if (session('status'))
  ...
  @php
    ...
    <tr>
      ...
      <td>{{$chauffeur->Emission}}</td>
      <td>{{$chauffeur->Expiration}}</td>
      <td>{{$chauffeur->Categorie}}</td>
      <td>
        <a href="modifier/{{ $chauffeur->id }}" class="btn btn-info">Modifier</a>
        <a href="supprimer/{{ $chauffeur->id }}" class="btn btn-danger">Supprimer</a>
      </td>
    </tr>
    @php
    $ide += 1;
