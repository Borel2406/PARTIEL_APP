...
<main class="container">
  ...
  <div class="my-3 p-3 bg-body rounded shadow-sm">
    <h4 class="border-bottom pb-2 mb-4">Liste des Voitures  Validés</h4>
    <div class="mt-4">
        <div class="d-flex justify-content-end  mb-3">
        <a href="ajoutervoiture" class="btn btn-primary">Ajouter une voiture</a>
        </div><hr>
          @if (session('status'))
  ...
  <thead>
     <tr>
      ...
      <th scope="col">ParcoursDefaut</th>
  ...
  @php
    ...
    <tr>
      ...
      <td>{{$voiture->ParcoursDefaut}}</td>
      <td>{{$voiture->Matricule}}</td>
      <td>{{$voiture->Marque}}</td>
      <td>{{$voiture->Couleur}}</td>
      <td>{{$voiture->Statut}}</td>
      <td>{{$voiture->Chauffeur->Nom}}</td>
      <td>
        <a href="/modifiervoiture/{{$voiture->id}}" class="btn btn-info">Modifier</a>
        <a href="supprimervoiture/{{ $voiture->id }}" class="btn btn-danger">Supprimer</a>
      </td>
    </tr>
    @php
    $ide += 1;
    ...
    <div class="d-flex justify-content-end  mb-3">
        <a href="dashboard" class="btn btn-success">Retour à l'accueil</a>
        </div><hr>
